...
const UNIS = [
  ...
  ["michigan", "University of Michigan", "Michigan", "Ann Arbor", "MI", ET],
  ["gatech", "Georgia Institute of Technology", "Georgia Tech", "Atlanta", "GA", ET],
  ["utaustin", "University of Texas at Austin", "UT Austin", "Austin", "TX", CT],
  ["uw", "University of Washington", "UW", "Seattle", "WA", PT],
  ["illinois", "University of Illinois Urbana-Champaign", "Illinois", "Urbana", "IL", CT],
  ["purdue", "Purdue University", "Purdue", "West Lafayette", "IN", ET],
  ...
  ["uva", "University of Virginia", "UVA", "Charlottesville", "VA", ET],
  ...
  ["columbia", "Columbia University", "Columbia", "New York", "NY", ET],
  ...
  ["osu", "Ohio State University", "Ohio State", "Columbus", "OH", ET],
  ["pennstate", "Pennsylvania State University", "Penn State", "University Park", "PA", ET],
  ["maryland", "University of Maryland", "Maryland", "College Park", "MD", ET],
  ["florida", "University of Florida", "Florida", "Gainesville", "FL", ET],
  ["georgia", "University of Georgia", "Georgia", "Athens", "GA", ET],
  ["tamu", "Texas A&M University", "Texas A&M", "College Station", "TX", CT],
  ["asu", "Arizona State University", "ASU", "Tempe", "AZ", AZ],
  ["indiana", "Indiana University Bloomington", "Indiana", "Bloomington", "IN", ET],
  ["iowa", "University of Iowa", "Iowa", "Iowa City", "IA", CT],
  ["minnesota", "University of Minnesota", "Minnesota", "Minneapolis", "MN", CT],
  ["colorado", "University of Colorado Boulder", "CU Boulder", "Boulder", "CO", MT],
  ["oregon", "University of Oregon", "Oregon", "Eugene", "OR", PT],
  ["pitt", "University of Pittsburgh", "Pitt", "Pittsburgh", "PA", ET],
  ["rutgers", "Rutgers University", "Rutgers", "New Brunswick", "NJ", ET],
  ...
  ["tulane", "Tulane University", "Tulane", "New Orleans", "LA", CT],
