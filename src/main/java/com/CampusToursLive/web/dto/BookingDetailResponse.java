 ...
 *
 * <p>{@code displayStatus} is the frontend-facing status string (e.g. "WAITING_FOR_GUIDE"), mapped
 * from the internal {@code BookingStatus} by {@code BookingStatus.displayStatus()}.
 *
