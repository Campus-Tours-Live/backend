 ...
 * INPUTS to the projection, applied left-to-right with {@code ADDITIONAL} overriding {@code
 * UNAVAILABLE} on overlap, then coalesced into the materialized occurrences.
 */
@Getter
@Setter
@Entity
